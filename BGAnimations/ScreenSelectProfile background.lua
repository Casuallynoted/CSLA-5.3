...
if bUse3dModels() == 'On' then
	...
	t[#t+1] = Def.ActorFrame{
		...
		Def.ActorFrame{
			InitCommand=cmd(x,SCREEN_RIGHT-400;y,SCREEN_CENTER_Y+50;zoom,0.45;);
			OnCommand=cmd(diffusealpha,0;addx,200;decelerate,0.4;diffusealpha,1;addx,-200;queuecommand,"Repeat";);
	...
	t[#t+1] = Def.Quad {
		InitCommand=cmd(FullScreen;diffuse,color("0,1,0.9,1");diffuserightedge,color("0,1,0.9,0.35"););
		OnCommand=cmd(linear,0.5;diffuse,color("0,1,0.9,0.35");diffuserightedge,color("0,0,0,0.35"););
	};
end;
