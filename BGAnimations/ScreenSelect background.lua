...
if bUse3dModels() == 'On' then
	t[#t+1] = Def.ActorFrame{
		...
		LoadActor( THEME:GetPathB("_shared","models/_l_wall1") )..{
			...
			SetCommand=cmd(zoom,1;rotationy,200;rotationz,200;zoom,1;queuecommand,"Repeat";);
	...
	t[#t+1] = Def.ActorFrame{
		...
		Def.ActorFrame{
			...
			SetCommand=cmd(queuecommand,"Repeat";);
			RepeatCommand=cmd(spin;effectmagnitude,10,2,5;);
