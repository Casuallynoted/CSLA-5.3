...
t[#t+1] = Def.ActorFrame{
	...
	Def.ActorFrame{
		InitCommand=cmd(x,SCREEN_CENTER_X;zoomx,10;zoomy,0;y,SCREEN_CENTER_Y+52;);
		OnCommand=cmd(sleep,0.2;decelerate,0.3;zoom,1;);
		LoadActor(THEME:GetPathG("ScreenSelectMusic","BannerFrame/_bannerback2"))..{
			CurrentSongChangedMessageCommand=cmd(y,-8;stoptweening;diffusealpha,1;x,6;decelerate,0.15;x,2;diffusealpha,1;glow,color("0.6,0.3,0,0.75");decelerate,0.15;glow,color("0.6,0.3,0,0"););
		};
		LoadActor(THEME:GetPathG("ScreenSelectMusic","BannerFrame/_bannerback2"))..{
			CurrentSongChangedMessageCommand=cmd(y,8;rotationz,180;stoptweening;diffusealpha,1;x,2;decelerate,0.15;x,6;glow,color("0.6,0.3,0,0.75");decelerate,0.15;glow,color("0.6,0.3,0,0"););
		};
	};
};
